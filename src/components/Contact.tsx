    ...
    >
      <div id="contact_card" className="w-2/4 max-md:w-full text-center">
        ...
        <p className="text-xl tracking-widest font-light py-5">
          Feel free to drop me a message Whether you have inquiries,
          collaboration proposals, or just want to discuss the latest tech
          trends, I'll get back to you as soon as possible. Your feedback,
          questions, and ideas are highly valued. Let's build something amazing
          together!
        </p>
        <motion.a
        ...
        <motion.a
          href="https://www.upwork.com/freelancers/~012fda8d55f862fe5f"
          target="_blank"
          className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-purple-400 uppercase font-bold m-5"
          whileHover={{ filter: "blur(0.5px)", scale: 1.4 }}
          transition={{ duration: 0.5, type: "spring" }}
